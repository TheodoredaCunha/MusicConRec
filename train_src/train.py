...
def get_env_paths():
    ...
    if is_sagemaker:
        ...
        metadata_dir = os.environ.get("SM_CHANNEL_TRAIN_METADATA") or os.environ.get("SM_CHANNEL_METADATA")
    ...
    return train_dir, val_dir, model_dir, log_dir, metadata_dir
...
def train():
    ...
    # PATHS (AUTO SWITCH)
    # =========================
    train_dir, val_dir, model_dir, log_dir, metadata_dir = get_env_paths()
    ...
    # DATASETS
    # =========================
    train_dataset = MusicBenchDataset(
        os.path.join(metadata_dir, hp['traindata_dir']),
        train_dir
    )
    val_dataset = MusicBenchDataset(
        os.path.join(metadata_dir, hp['valdata_dir']),
        val_dir
    )
